...
#import "Utilities.h"
//#import <VisageHeaders/TrackerGazeCalibration.h>
...
- (void)initTracker:(CustomGLView *)view
{
    ...
    else if ([deviceType hasPrefix:@"iPhone6"])
        tracker = new VisageTracker2("FFT - HighPerformance.cfg");     // iPhone6
...
//    VisageSDK::ScreenSpaceGazeData gaze = trackingData.gazeData;
...
- (void)calibrate {
    ...
    tracker->AddGazeCalibrationPoint(0.1f, 0.1f);
//    tracker->AddGazeCalibrationPoint(0.5, 0.5);
//    tracker->AddGazeCalibrationPoint(0.9, 0.9);
//    tracker->AddGazeCalibrationPoint(0.1, 0.5);
//    tracker->AddGazeCalibrationPoint(0.5, 0.1);
//    tracker->AddGazeCalibrationPoint(0.1, 0.9);
//    tracker->AddGazeCalibrationPoint(0.9, 0.1);
//    tracker->AddGazeCalibrationPoint(0.5, 0.9);
//    tracker->AddGazeCalibrationPoint(0.9, 0.5);
